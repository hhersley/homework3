...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="https://homework2.hahersley.oucreate.com/#">Homework3</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="https://homework3.hahersley.oucreate.com/Adaption.html">Page 2</a>
        </li>
            <li class="nav-item">
